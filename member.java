...
public class member {
    String name , address , reg_name ,time, reg_phone , fulldisp , AMC_expireing , Reg_Date , Email , payment_id , payment_date , spare_part , noMachine , status , taken , takenphone;

    public member() {
    }

    public member(String name, String address,String status,String time, String reg_name,String noMachine, String reg_phone, String fulldisp, String AMC_expireing, String Reg_Date , String Email , String payment_id , String payment_date , String spare_part) {
        this.name = name;
    ...
    public String getTakenphone() {
        return takenphone;
    }

    public void setTakenphone(String takenphone) {
        this.takenphone = takenphone;
    }
